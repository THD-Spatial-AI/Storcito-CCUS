...
# Create classified raster style
create_style() {
    log "Creating classified raster style..."
...
<sld:StyledLayerDescriptor xmlns:sld="http://www.opengis.net/sld"
                           ...
                           version="1.0.0">
  <sld:NamedLayer>
    <sld:Name>result_transparent</sld:Name>
    <sld:UserStyle>
      <sld:Title>Classified Result with Transparent Background</sld:Title>
        ...
        <sld:Rule>
          <sld:RasterSymbolizer>
            ...
            <sld:ColorMap type="values">
              ...
              <sld:ColorMapEntry color="#2563eb" quantity="1" opacity="1.0" label="Level 1"/>
              <sld:ColorMapEntry color="#16a34a" quantity="2" opacity="1.0" label="Level 2"/>
              <sld:ColorMapEntry color="#eab308" quantity="3" opacity="1.0" label="Level 3"/>
              <sld:ColorMapEntry color="#ea580c" quantity="4" opacity="1.0" label="Level 4"/>
              <sld:ColorMapEntry color="#dc2626" quantity="5" opacity="1.0" label="Level 5"/>
            </sld:ColorMap>
