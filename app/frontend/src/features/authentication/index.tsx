...
const AnalysisSidePanel: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 bg-[#16152e]">
      <img
        src={`${IMG}/ccus-transport-map.png`}
...
const BrandLogo = (
  <div className="flex items-center justify-center gap-2.5 mb-1">
    ...
    />
    <span className="h-4 w-[1.5px] bg-amber-500/60 dark:bg-amber-400/60 rounded-full shrink-0" />
    <span className="text-xs font-semibold uppercase tracking-[0.15em] text-amber-600 dark:text-amber-400">
      CCUS Assessment
    </span>
  </div>
);
