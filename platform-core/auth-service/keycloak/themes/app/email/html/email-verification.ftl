...
<head>
    ...
    <title>Verify Your Email - App</title>
    <!--[if mso]>
    <style type="text/css">
                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0, 0, 0, 0.08);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); padding: 36px 32px; text-align: center;">
                            ...
                            <h1 style="margin: 0; font-size: 28px; font-weight: 800; color: #ffffff; letter-spacing: 0.5px; text-transform: uppercase;">App</h1>
                                ...
                                <tr>
                                    <td style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 12px; padding: 20px 24px;">
                                        <p style="margin: 0; font-size: 15px; color: #374151; line-height: 1.6;">
                                            Your App account has been created. Please verify your email address to activate your account and start using our energy simulation platform.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="background-color: #111827; padding: 32px 36px; text-align: center;">
                            <p style="margin: 0 0 6px; font-size: 16px; font-weight: 700; color: #ffffff; text-transform: uppercase; letter-spacing: 0.5px;">App</p>
                            ...
                            <p style="margin: 0; font-size: 11px; color: #d1d5db;">&copy; 2026 App. All rights reserved.</p>
                        </td>
                    </tr>
