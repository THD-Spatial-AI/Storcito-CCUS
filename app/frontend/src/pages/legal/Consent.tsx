    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none text-foreground">
        <p>
          ...
          related to my use of App.
        </p>
        <p>
          I understand that any data I provide for analysis model creation will be used solely for
        ...
        <p>
          ...
          time by contacting the App Team from the Deggendorf University of Technology at{" "}
          <a href="mailto:support@example.com">support&#64;example.com</a>. Upon revocation, my
        ...
        <p>
          ...
          notified of significant changes, and my continued use of App after such
