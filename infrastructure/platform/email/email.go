...
<span style="color:#ffffff;font-size:20px;font-weight:600;letter-spacing:-0.025em">Spatial Hub</span>
</td>
</tr>
</table>
<p style="color:#9ca3af;margin:12px 0 0 0;font-size:13px;font-weight:400">Geospatial Analysis Platform</p>
</td></tr>
...
This is an automated notification from Spatial Hub.<br>
