...
<head>
    ...
    <title>${msg("loginTitle",(realm.displayName!'App'))}</title>
    <style>
...
<body>
    <div class="ep-container">
        <div class="ep-card">
            <!-- Header -->
            <div class="ep-header">
                <img class="ep-logo-img" src="${url.resourcesPath}/img/logo.png" alt="${realm.displayName!'App'}"/>
            ...
            <!-- Footer -->
            <div class="ep-footer">
                <div class="ep-footer-brand">App</div>
                <div class="ep-footer-text">Technische Hochschule Deggendorf</div>
                <div class="ep-footer-copy">&copy; 2026 App. All rights reserved.</div>
            </div>
        </div>
    </div>
</body>
