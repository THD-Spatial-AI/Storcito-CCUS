-- Migration: Create analysis models table
-- Created: 2025-10-16
-- Description: Clean schema for analysis models with workspace reference and polygon coordinates
...
-- Comments
COMMENT ON TABLE models IS 'Analysis models with polygon coordinates and workspace references';
